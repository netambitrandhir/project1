...
public class FilterListAdapter extends BaseAdapter {
    ...
    public FilterListAdapter(Context context, ArrayList<Category> arrayListCategory) {
        ...
        viewHolder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (arrayListCategory.get(position).isChecked() == true) {
                    ...
                    NearbyShops.alist.add(arrayListCategory.get(position));
                } else {
                    arrayListCategory.get(position).setChecked(true);
                    NearbyShops.alist.remove(arrayListCategory.get(position));
                }
