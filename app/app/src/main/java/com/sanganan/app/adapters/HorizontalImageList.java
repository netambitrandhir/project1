 ...
 */
public class HorizontalImageList extends BaseAdapter {
    private LayoutInflater inflater;
    Context context;
    ArrayList<String> imageList;


    public HorizontalImageList(Context context, ArrayList<String> imageList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.image_horizontal_list, null);
